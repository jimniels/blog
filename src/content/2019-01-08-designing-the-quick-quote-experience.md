...
![First iteration screenshot for starting a new quote](/images/2019/qqs-v1-start.png "Zero state when starting a new quote (v1)")
...
![First iteration screenshot for the address selection when starting a new quote](/images/2019/qqs-v1-property-step-1.png "Address autocomplete")
...
![First iteration screenshot for smart defaults](/images/2019/qqs-v1-property-step-2.png "With just the address, the form is ready to be submitted")
...
![First iteration screenshot for 1+ products](/images/2019/qqs-v1-property-step-3.png "Covering an edge case of 1+ products")
...
![First iteration screenshot for 0 products](/images/2019/qqs-v1-property-step-4.png "Gather further feedback when we couldn’t provide what the user was looking for")
...
![First iteration screenshot for starting a quote by choosing a property](/images/2019/qqs-v1-product-step-1.png "Start a new quote by specifying the insurance product you want")
...
![First iteration screenshot for starting a quote by choosing a property](/images/2019/qqs-v1-product-step-2.png "Different options would automatically fill in based on your choices")
...
![Second iteration screenshot for starting a new quote](/images/2019/qqs-v2-example.png "A combination of all UI choices from the first iteration in a single form")
...
![Second iteration animated gif for starting a new quote](/images/2019/qqs-v2-flow.gif)
...
![Third iteration of initial step for starting a new quote](/images/2019/qqs-v3-step-1.png "Initial screen where you enter an address")

![Third iteration of address autosuggest step for starting a new quote](/images/2019/qqs-v3-step-2.png "Autosuggest of addresses lets you quickly find an address")

![Third iteration of choosing a product when starting a new quote](/images/2019/qqs-v3-step-3.png "Dynamic list of products populates on the right as values on the left are changed")
...
![First version of the fourth iteration for product selection when starting a new quote](/images/2019/qqs-v4-iteration-1.png)

That didn’t quite feel right, so I tried redrawing the insurance products as smaller thumbnails.

![Second version of the fourth iteration for product selection when starting a new quote](/images/2019/qqs-v4-iteration-2.png)
...
![Third version of the fourth iteration for product selection when starting a new quote](/images/2019/qqs-v4-iteration-3.png)
...
![Final version of the fourth iteration for product selection when starting a new quote](/images/2019/qqs-v4-iteration-4.png)
...
![Final mock for when no addresses could be found when starting a new quote](/images/2019/qqs-final-no-auto-suggestions.png "When no address could be found through Google’s API, we provided a shortcut to switching to a U.S. state input.")

![Final mock for when no products could be found when starting a new quote](/images/2019/qqs-final-no-products.png "When no products were available, we asked for feedback so we could better discover what our clients were needing.")

![Final mock for when no products could be found when starting a new quote](/images/2019/qqs-final-no-accessible-products.png "When no products were accessible, we asked for further feedback along with the option to get in contact with the client to help them find what they needed.")

Oh, and in case you’re curious, there was the initial screen that the user would see when no data had been entered yet.

![Final mock for the initial zero state when starting a new quote](/images/2019/qqs-final-initial.png)
...
![Photo of sketch for UI ideas on solving address field edge case bug](/images/2019/qqs-address-fix-drawing.jpg "Sketch of ideas on incorporating handling address search edge cases inside the address lookup field.")
...
![Animated gif of the address edge case UI as a mock](/images/2019/qqs-address-fix-flow-mock.gif)

When this actually got wired up, it looked something like this:

![Animated gif of the address edge case UI as a live example](/images/2019/qqs-address-fix-flow-live.gif)
