...
In fact, Bryan says that the team’s breakthroughs on these bugs were solutions that an artificial super intelligence would’ve never suggested because they ran _against_  all known and available reasoning, documentation, and knowledge.
...
If human values like curiosity are what led to breakthroughs — _not_ the application of synthetic intelligence — why is there so much emphasis on intelligence these days? Bryan has a curt analysis:
