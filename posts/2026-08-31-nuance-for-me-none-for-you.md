...
Eric Bailey has [a fun little post](https://ericwbailey.website/published/a-proposal-for-new-netflix-content-rating-icons/) about how we need more than a few icons to express the nuance of our shared human experience.
...
We know when we click that button that it’s a reductive expression of our experience that’ll be erroneously interpreted, but we do it anyway. [As Bryan Cantrill shared](https://notes.jim-nielsen.com/n/2026-08-18-1006/) from his experience:
...
Yet we turn around in our professional contexts and see numbers like “142,432 users gave this a ‘thumbs up’” and we forget everything we knew about our own individual experience with these systems. We make it mean what we want it to mean, what’s convenient for measurement and reporting e.g. “Wow, what a great insight about our offerings! Let’s restructure our entire catalog around this new, objective, [(pseudo)](https://blog.jim-nielsen.com/2025/product-pseudoscience/)scientific fact that so many people obviously like this thing!”

[We reduce the experiences of others to mere data, but grant ourselves exemption from such oversimplifications.](https://blog.jim-nielsen.com/2024/seeing-others-in-data-but-not-ourselves/)

Where’s the conversation around:

- Values, e.g. “Should we provide more of this? [We can say no to the data…](https://blog.jim-nielsen.com/2026/say-no-to-data/)”
...
But that’s too introspective. Introspection is slow. [Ain’t nobody got time for that.](https://blog.jim-nielsen.com/2026/speed-not-conducive-to-wisdom/)